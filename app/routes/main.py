from flask import render_template, url_for, current_app, Blueprint, request, flash, redirect
...
def projects():
    ...
    if query:
        projects = [p for p in projects if query in p['name'].lower() or query in p['description'].lower()]
    ...
    return render_template('projects.html', projects=projects, current_year=current_year, search_query=query)
